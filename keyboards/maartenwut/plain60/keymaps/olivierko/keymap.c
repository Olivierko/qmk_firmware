...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BL] = LAYOUT_60_hhkb(
		...
		KC_LSFT, 	KC_Z,	  	KC_X,	 	KC_C,		KC_V,		KC_B,		KC_N,		KC_M,		KC_COMM,	KC_DOT,		KC_SLSH,	KC_RSFT, 	KC_LGUI,
					MO(_FL),  	KC_LALT, 										KC_SPC,											KC_RALT,	MO(_FL)),
	...
	[_FL] = LAYOUT_60_hhkb(
		...
		KC_LSFT,	KC_NO,		KC_NO,		KC_CAPS,	KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_COMM,	KC_DOT,		KC_SLSH,	KC_RSFT,	MO(_CL),
					KC_NO,		KC_LALT,										KC_SPC,											KC_RALT,	KC_NO),

	[_CL] = LAYOUT_60_hhkb(
		KC_NO,		KC_F13,		KC_F14,		KC_F15,		KC_F16,		KC_F17,		KC_F18,		KC_F19,		KC_F20,		KC_F21,		KC_F22,		KC_F23,		KC_F24,		KC_NO,			KC_NO,
		KC_NO,		KC_NO,		KC_NO,		KC_NO,		RESET,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_DELETE,
