...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_FL] = LAYOUT_60_tsangan_hhkb(
		...
		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_HOME,	KC_UP,		KC_END,		KC_NO,		KC_NO,		KC_NO,		KC_DELETE,
		KC_NO,		DF(_BL),	DF(_SL),	KC_NO,		KC_NO,		KC_NO,		KC_PGUP,	KC_LEFT,	KC_DOWN,	KC_RIGHT,	KC_PGDOWN,	KC_NO,		KC_INS,
		KC_LSFT,	KC_MPRV,	KC_MNXT,	KC_CAPS,	KC_NO,		KC_NO,		KC_NO,		KC_MUTE,	KC_NO,		KC_NO,		KC_NO,		KC_RSFT,	KC_NO,
		KC_LCTL,	MO(_CL),	KC_LALT,										KC_MPLY,										KC_RALT,	KC_RGUI,	KC_RCTL),
	...
	[_CL] = LAYOUT_60_tsangan_hhkb(
		...
		KC_LSFT,	KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_RSFT,	KC_NO,
